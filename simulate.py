...
# Global Parameters
default_model_path = './model/model-RL'
default_simulate_type = 1  # use one former sent
...
# Extracting the vocabulary part of the data 
def refine(data):
...
def generate_answer_sentence(generated_word_index, prob_logit, ixtoword):
    ...
    # modify the output sentence to make it legible
    ...
    with open(output_path, 'w') as out:
        for idx, start_sentence in enumerate(testing_data):
            ...
            for turn in range(max_turns):
                #generating the question vector
                ...
                #Saving the generated sentence in dialogue history
                dialog_history.append(generated_sentence)
                print('B => {}'.format(generated_sentence))

                #Generating the 2nd question
...
if __name__ == "__main__":
    ...
    n_encode_lstm_step = n_encode_lstm_step * simulate_type + 1  
